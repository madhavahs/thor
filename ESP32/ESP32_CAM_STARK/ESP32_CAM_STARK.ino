...
#define STARK_DEVICE_ID   "STARK_CAM_01"
#define STARK_AUTH_TOKEN  "blynk_tok_6d0574f54a" // Your active token
...
void setup() {
  ...
  wifiMulti.addAP("YOUR_PRIMARY_WIFI", "PRIMARY_PASSWORD");     // Network 1: Home Wi-Fi
  wifiMulti.addAP("YOUR_PHONE_HOTSPOT", "HOTSPOT_PASSWORD");    // Network 2: Mobile Hotspot
